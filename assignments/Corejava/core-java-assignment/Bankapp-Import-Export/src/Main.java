...
import Service.AccountServiceHashImpl;
import java.util.Scanner;
public class Main {
    public static void main(String[] args) {
        AccountServiceHashImpl accountService = new AccountServiceHashImpl();
    ...
    private static void printStatistics(AccountServiceHashImpl accountService) {
